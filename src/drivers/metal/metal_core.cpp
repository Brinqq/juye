...
class Scene{
public:
  juye::Prefab cube_red;
  juye::Prefab cube_texture;
  juye::Prefab plane;
  MTL::Viewport viewport;

  Scene(){
    cube_red = juye::Prefab::Builder().SetMesh(juye::Prefab::PrefabMeshCube).Build();
    cube_texture = juye::Prefab::Builder().SetMesh(juye::Prefab::PrefabMeshCube).Build();
    plane = juye::Prefab::Builder().SetMesh(juye::Prefab::PrefabMeshPlane).Build();
    viewport = MTL::Viewport{0.0,0.0,3000.0,2000.0, 0.0, 1.0};
  }
